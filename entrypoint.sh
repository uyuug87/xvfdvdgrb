...
UUID=${UUID:-'933e3eff-3e31-419b-b226-e9b096ea2df9'}
VMESS_WSPATH=${VMESS_WSPATH:-'/933e3eff-3e31-419b-b226-e9b096ea2df9-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/933e3eff-3e31-419b-b226-e9b096ea2df9-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/933e3eff-3e31-419b-b226-e9b096ea2df9-trojan'}
SS_WSPATH=${SS_WSPATH:-'/933e3eff-3e31-419b-b226-e9b096ea2df9-shadowsocks'}
